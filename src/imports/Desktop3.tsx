      ...
      <main className="tw-62f626a1ba">
        ...
        <section id="black-death" className="tw-92019049cb">
          <div className="tw-de042df702">
            ...
            <div className="tw-91ab5d9418">
              <p>
                흑사병(Black Death)은 Yersinia pestis 세균에 의해 발생하는 급성 전염병으로, 14세기 유럽 전역에서 대유행하면서 인류 역사상 가장 치명적인 팬데믹 중 하나로 기록된다. 이 병은 쥐에{" "}
                <br />
                기생하던 벼룩이 사람에게 세균을 옮기는 방식으로 전파되었으며, 전쟁과 무역, 인구 이동, 밀집된 도시 환경 등이 확산을 크게 가속시켰다. 주요 증상으로는 고열, 극심한 통증, 림프샘이{" "}
                <br />
                부어오르는 부보(bubo) 등이 나타난다.
              </p>
              <p>
                흑사병은 1347년 콘스탄티노플과 시칠리아에서 시작해 이탈리아, 프랑스, 영국, 북유럽으로 빠르게 퍼졌으며, 1351년까지 약 4간 지속되었다. 이 기간 동안 유럽 인구의 30~50%가 사망한{" "}
                <br />
                것으로 추정되며, 일부 지역에서는 절반 이상이 사라지기도 했다.
              </p>
            </div>
        ...
        <section id="spanish-flu" className="tw-92019049cb">
          <div className="tw-de042df702">
            ...
            <div className="tw-91ab5d9418">
              <p>
                스페인독감(Spanish Flu)은 H1N1 인플루엔자 A 바이러스에 의해 발생한 급성 호흡기 감염병으로, 1918~1920년 전 세계를 휩쓴 팬데믹이다. 기침과 재채기에서 발생하는 비말을 통해 사람 간에 쉽게 전파되었으며, 제1차 세계대전으로 인한 대규모 병력 이동, 기차·선박을 통한 빠른 국제 이동, 군대와 도시의 밀집된 생활환경 등이 확산을 크게 가속시켰다. 주요 증상은 고열, 기침, 극심한{" "}
                <br />
                피로 등이며, 폐렴으로 급격히 악화되어 사망에 이르는 사례가 많았다.
              </p>
              <p>
        ...
        <section id="aids" className="tw-92019049cb">
          <div className="tw-de042df702">
            ...
            <div className="tw-91ab5d9418">
              <p>
                에이즈(AIDS)는 인간 면역결핍 바이러스(HIV)에 감염되면서 면역체계가 서서히 파괴되는 질병으로, 체내 방어 기능이 크게 약화되어 다양한 감염과 합병증에 취약해진다. 초기에는 'GRID
                <br />
                (Gay-Related Immune Deficiency)'로 불렸으나, 감염 사례가 성적 지향과 무관하게 나타나면서 AIDS라는 공식 명칭이 사용되었다. HIV는 주로 성접촉, 오염된 혈액, 출산 수유 과정에서 전염되며, CD4+ T세포를 공격하여 발열, 근육통, 체중 감소, 폐렴 등의 증상을 유발한다. AIDS는 1981년 미국에서 처음 공식 보고된 이후 현재까지 전 세계적으로 유행하고 있으며, 급성 폭발적 확산보다는 장기간에 걸쳐 면역 결핍 합병증으로 사망자가 발생하는 특징을 지닌다. 2017년 기준 약 94만 명이 AIDS 관련 질환으로 사망한 것으로 보고되며, 면역력 저하로 인한 폐렴 등 기회감염이{" "}
                <br />
                주요 사망 원인이 되고 있다.
              </p>
            </div>
