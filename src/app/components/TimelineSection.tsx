  ...
  const timelineData: TimelineItem[] = [
    {
      ...
      period: "1347-1351",
      description: "14세기 유럽 인구의 약 3분의 1을 사망하게 한, 인류 역사상 가장 치명적인 팬데믹",
      type: "세균 감염병(Yersinia pestis)",
      transmission: "쥐에 기생한 벼룩을 통해 전파되며, 도시 밀집·무역·전쟁으로 급속 확산",
    ...
    },
    {
      ...
      period: "1918-1920",
      description: "전 세계적으로 약 5천만 명 이상의 사망자를 낳은 20세기 최악의 인플루엔자 팬데믹",
    ...
    },
    {
      title: "에이즈 (AIDS, 1981~ )",
      period: "1981-현재",
      description: "HIV 감염으로 면역체계가 파괴되는 만성 감염병으로, 현재까지 전 세계적 사망자가 매우 많은 현대 대표 팬데믹",
    ...
    },
    {
      ...
      period: "2019-현재",
      description: "2019년 우한에서 시작해 전 세계로 동시 확산된 현대 최대 규모의 호흡기 팬데믹",
