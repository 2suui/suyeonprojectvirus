...
const WrappedRetroTyped = WrappedRetro as unknown as ForwardRefExoticComponent<
  RetroEffectProps & RefAttributes<Effect>
>;

const RetroEffect = forwardRef<Effect, RetroEffectProps>(({ colorNum, pixelSize }, ref) => {
  return <WrappedRetroTyped ref={ref} colorNum={colorNum} pixelSize={pixelSize} />;
});
...
export type DitherProps = Partial<{
  waveSpeed: number;
  waveFrequency: number;
  waveAmplitude: number;
  waveColor: [number, number, number];
