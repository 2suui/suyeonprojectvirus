    ...
    <div className="tw-3674edd26c">
      ...
      >
        <p>
          ...
          '길(Path)'이라는 이름처럼, 인류가 지나온 전염병의 흐름을 따라가며 주요 사건, 확산 과정,{" "}
          <br />
          사회적 영향을 직관적으로 이해할 수 있도록 구성되어 있습니다. 
      ...
      >
        <p>
          ...
          감염병은 세균,{" "}
          <br />
          바이러스, 기생충 등이 특정 매개체(예: 모기, 오염된 주사 바늘, 성행위 등)를 통해 전파됩니다. 따라서 매개체를 차단하는 것이 감염병 예방의 핵심입니다.
        </p>
        <p>
          반면 전염병은 별도의 매개체 없이 일상적인 생활 활동만으로도 감염될 수 있는 질병입니다. 오염된 물건을 만지거나 병원체가 포함된 공기를 흡입하거나 오염된 물을 마시는 등 자연스러운{" "}
          <br />
          행동 속에서 전파됩니다. 전염병은 개인의 건강 문제를 넘어 사회 전체의 생존과 구조를 흔들 수 있는 큰 위협입니다. 때로는 인간의 생활 방식뿐만 아니라 역사와 세계의 흐름까지 바꾸는{" "}
          <br />
          힘을 지니고 있습니다.
        </p>
        <div lang="en" className="tw-65cf08baac">
